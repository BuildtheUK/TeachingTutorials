...
import org.btuk.teachingtutorials.tutorialplaythrough.TutorialPlaythrough;
...
public class WorldEditCalculation
{
    ...
    public void runCalculation()
    {
        ...
        if (org.btuk.teachingtutorials.utils.WorldEdit.isCurrentCalculationOngoing())
        {
            return;
        }
        org.btuk.teachingtutorials.utils.WorldEdit.setCalculationInProgress(plugin.getLogger());
    ...
    private void recordRealBlocksAndSetVirtualsAndRunCommand()
    {
        ...
        if (org.btuk.teachingtutorials.utils.WorldEdit.areVirtualBlocksOnRealWorld())
        {
        ...
        else
        {
            ...
            org.btuk.teachingtutorials.utils.WorldEdit.setVirtualBlocksOnRealWorld(plugin.getLogger());
    ...
    private void unblockCalculationQueue()
    {
        ...
        org.btuk.teachingtutorials.utils.WorldEdit.pendingCalculations.remove(this);
        org.btuk.teachingtutorials.utils.WorldEdit.setCalculationFinished(plugin.getLogger());
        plugin.getLogger().log(Level.INFO, "Unblocked calculation queue from task: " +iTaskID);
        plugin.getLogger().log(Level.INFO, ChatColor.GREEN +"There are " + org.btuk.teachingtutorials.utils.WorldEdit.pendingCalculations.size() +" calculations remaining in the queue");
    }
                ...
                public void run()
                {
                    ...
                    Bukkit.getScheduler().runTaskLater(plugin, new Runnable() {
                        ...
                        public void run() {
                            ...
                            org.btuk.teachingtutorials.utils.WorldEdit.setVirtualBlocksOffRealWorld(plugin.getLogger());
